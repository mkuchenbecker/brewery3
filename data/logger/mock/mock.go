...
// Source: github.com/mkuchenbecker/brewery3/data/logger (interfaces: Log,LoggerGetter,Logger)
...
// MockLoggerGetter is a mock of LoggerGetter interface
type MockLoggerGetter struct {
	ctrl     *gomock.Controller
	recorder *MockLoggerGetterMockRecorder
}

// MockLoggerGetterMockRecorder is the mock recorder for MockLoggerGetter
type MockLoggerGetterMockRecorder struct {
	mock *MockLoggerGetter
}

// NewMockLoggerGetter creates a new mock instance
func NewMockLoggerGetter(ctrl *gomock.Controller) *MockLoggerGetter {
	mock := &MockLoggerGetter{ctrl: ctrl}
	mock.recorder = &MockLoggerGetterMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use
func (m *MockLoggerGetter) EXPECT() *MockLoggerGetterMockRecorder {
	return m.recorder
}

// Get mocks base method
func (m *MockLoggerGetter) Get(arg0 logger.Severity) logger.Logger {
	m.ctrl.T.Helper()
...
func (mr *MockLoggerGetterMockRecorder) Get(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockLoggerGetter)(nil).Get), arg0)
}
